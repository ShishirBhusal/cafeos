...
// CafeOS doesn't need a separate footer - it's included in the landing page
// For authenticated pages, we have minimal footer
  ...
  return (
    <html lang="en">
      <body className={`${inter.variable} antialiased bg-white`}>
        ...
        {/* CafeOS Header */}
        <CafeOSHeader isAuthed={isAuthenticated} />
