        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-800">
              ...
              {mode === 'signup' && 'Create Your Cafe'}
              {mode === 'forgot' && 'Reset Password'}
            </h1>
            <p className="text-gray-500 mt-1">
              {mode === 'login' && (redirectTo.includes('cafe') ? 'Sign in to manage your cafe' : 'Sign in to CafeOS')}
              {mode === 'signup' && 'Join CafeOS — Free forever'}
          ...
          <form onSubmit={mode === 'login' ? handleLogin : mode === 'signup' ? handleSignup : handleForgotPassword}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-orange-600 text-white font-semibold rounded-lg hover:bg-orange-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
